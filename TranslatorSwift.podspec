...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TranslatorSwift.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/git/TranslatorSwift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'git' => 'kreuz45@kreuz45.com' }
  s.source           = { :git => 'https://github.com/git/TranslatorSwift.git', :tag => s.version.to_s }
